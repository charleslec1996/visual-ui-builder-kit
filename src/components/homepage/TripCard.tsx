...
const TripCard: React.FC<TripCardProps> = ({
  ...
  return <article className="bg-white self-stretch flex min-w-60 min-h-[682px] flex-col overflow-hidden items-stretch justify-center grow shrink w-[307px] my-auto p-6 rounded-[32px] max-md:px-5 max-w-[384px]">
